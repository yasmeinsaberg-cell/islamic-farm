...
const syllabus = [
    ...
    {
        chapter: "الباب الثاني: العقيدة الإسلامية (من كتاب ما لا يسع أطفال المسلمين جهله)",
        branches: [
            {
                title: "1. رَبُّنا ودينُنا ونبيُّنا",
                lesson: "💡 تذكر: ربي الله الذي رباني بنعمته، وديني الإسلام، ونبينا محمد صلى الله عليه وسلم.",
                questions: [
                    { q: "من ربك؟", options: ["الله الذي رباني بنعمته", "غير ذلك", "الطبيعة"], a: "الله الذي رباني بنعمته" },
                    { q: "ما دينك؟", options: ["الإسلام", "النصرانية", "اليهودية"], a: "الإسلام" },
                    { q: "من نبيك؟", options: ["محمد صلى الله عليه وسلم", "عيسى عليه السلام", "موسى عليه السلام"], a: "محمد صلى الله عليه وسلم" }
                ]
            },
            {
                title: "2. أركان الإيمان",
                lesson: "💡 تذكر: أركان الإيمان ستة: الإيمان بالله وملائكته وكتبه ورسله واليوم الآخر والقدر خيره وشره.",
                questions: [
                    { q: "كم عدد أركان الإيمان؟", options: ["خمسة", "ستة", "سبعة"], a: "ستة" },
                    { q: "من نزل بالوحي على الأنبياء من الملائكة؟", options: ["جبريل عليه السلام", "ميكائيل", "رافائيل"], a: "جبريل عليه السلام" }
                ]
            }
        ]
    }
